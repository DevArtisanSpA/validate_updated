  ...
  <body class="body">
    <div>
      ...
      <div style="text-align: left; ">
        <h2>
          Se han cargado los documentos mensuales de empleados para el periodo <strong>{{$periodo}}</strong>.
        </h2>
        <p><br>
          Para el servicio <strong>{{ strtoupper($service->description) }}</strong> de la empresa principal <strong>{{ strtoupper($service->branchOffice->company->business_name) }}</strong>, sucursal <strong>
            {{ strtoupper($service->branchOffice->name) }}</strong>, se han cargado los siguientes documentos mensuales para los empleados de
