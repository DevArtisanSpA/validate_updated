  ...
  <form @submit.prevent="checkForm" class="pt-2 pb-5">
    ...
    <b-modal ref="modal-confirm" hide-footer>
      <div slot="modal-title">
        <span>{{
          isUpdate
            ? "Se editará un servicio entre dos empresas"
            : "Se asociará un servicio entre dos empresas"
        }}</span>
      </div>
    ...
    <b-row>
      <b-col md="3">
        <label for="input-rut">
          <span class="text-danger">*</span> Rut Empresa contratista</label
        >
        <b-form-input
          id="input-rut"
          type="text"
      ...
      <b-col md="3">
        ...
        <b-form-invalid-feedback id="input-live-feedback"
          >La empresa que contrata es requerida</b-form-invalid-feedback
        >
      </b-col>
      <b-col md="3">
        <label for="input-branch-office">
          <span class="text-danger">*</span> Sucursal</label
        >
        <b-form-select
        ...
        <b-form-invalid-feedback id="input-live-feedback"
          >La sucursal es requerida</b-form-invalid-feedback
        >
      </b-col>
      <b-col md="3">
        <label for="input-service-type">
          <span class="text-danger">*</span> Tipo de servicio</label
        >
        <b-form-select
        ...
        <b-form-invalid-feedback id="input-live-feedback"
          >El tipo de servicio es requerido</b-form-invalid-feedback
        >
      </b-col>
    </b-row>
    <b-row>
      <b-col md="6">
        <label for="input-description">
          <span class="text-danger">*</span> Descripción del servicio
        </label>
        <b-form-input
        ...
        <b-form-invalid-feedback id="input-live-feedback"
          >La descripción del servicio es obligatorio</b-form-invalid-feedback
        >
      </b-col>
      <b-col md="3">
        ...
        />
        <b-form-invalid-feedback id="input-live-feedback"
          >La fecha de inicio es requerida</b-form-invalid-feedback
        >
      </b-col>
      <b-col md="3">
        ...
        />
        <b-form-invalid-feedback id="input-live-feedback"
          >La fecha de término es requerida</b-form-invalid-feedback
        >
      </b-col>
    </b-row>
    <b-row>
...
export default {
  ...
  mounted() {
    const { auth, serviceToUpdate } = this.$props;
